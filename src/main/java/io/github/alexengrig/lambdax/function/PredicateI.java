...
public interface PredicateI<T, R> {
   ...
   * @since 0.2.0
   */
  <V extends Comparable<V>> ComparablePredicateI<T, V>
   ...
   * @since 0.2.0
   */
  default Predicate<T> isNull() { return check(Objects::isNull); }
   ...
   * @since 0.2.0
   */
  default Predicate<T> nonNull() { return check(Objects::nonNull); }
   ...
   * @since 0.2.0
   */
  default Predicate<T> equal(R other) { return check(other::equals); }
