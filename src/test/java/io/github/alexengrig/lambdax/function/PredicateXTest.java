...
public class PredicateXTest {
    ...
    public void checkChecker() {
        ...
        Predicate<Holder<Box>> isEmptyItemName = PredicateX.old(Holder<Box>::get)
                .map(Box::getPack)
                .map(Pack::getItem)
                .map(Item::getName)
    ...
    public void checkCheckerNullable() {
        ...
        Predicate<Holder<Box>> isEmptyItemName = PredicateX.oldSafe(Holder<Box>::get)
                .map(Box::getPack)
                .map(Pack::getItem)
                .map(Item::getName)
    ...
    public void checkCheckerChaining() {
        ...
        List<Holder<Box>> list = Stream.of(boxHolder)
                .filter(PredicateX.old(Holder<Box>::get)
                        .map(Box::getPack)
                        .map(Pack::getItem)
                        .map(Item::getName)
                        .check(String::isEmpty))
    ...
    public void checkCheckerNullableChaining() {
        Holder<Box> boxHolder = new Holder<>(null);
        List<Holder<Box>> list = Stream.of(boxHolder)
                .filter(PredicateX.oldSafe(Holder<Box>::get)
                        .map(Box::getPack)
                        .map(Pack::getItem)
                        .map(Item::getName)
                        .check(String::isEmpty)
    ...
    public void checkIsNull() {
        ...
        Predicate<Pack> isNullItemName = PredicateX.old(Pack::getItem).map(Item::getName).isNull();
    ...
    public void checkIsNullNullable() {
        ...
        Predicate<Pack> isNullItemName = PredicateX.oldSafe(Pack::getItem).map(Item::getName).isNull();
    ...
    public void checkIsNullChaining() {
        ...
        List<Pack> list = Stream.of(pack)
                .filter(PredicateX.old(Pack::getItem).map(Item::getName).isNull())
                .collect(Collectors.toList());
        assertTrue(list.isEmpty());
    }
    ...
    public void checkIsNullNullableChaining() {
        Pack pack = new Pack(null);
        List<Pack> list = Stream.of(pack)
                .filter(PredicateX.oldSafe(Pack::getItem).map(Item::getName).isNull())
                .collect(Collectors.toList());
    ...
    public void checkNonNull() {
        ...
        Pack pack = new Pack(new Item(value));
        Predicate<Pack> nonNullItemName = PredicateX.old(Pack::getItem).map(Item::getName).nonNull();
    ...
    public void checkNonNullNullable() {
        ...
        Predicate<Holder<Box>> nonNullItemName = PredicateX.oldSafe(Holder<Box>::get).nonNull();
    ...
    public void checkNonNullNullableComparable() {
        Pack pack = new Pack(null);
        Predicate<Pack> nonNullItemName = PredicateX.oldSafe(Pack::getItem).map(Item::getName).nonNull();
    ...
    public void checkNonNullChaining() {
        ...
        Pack pack = new Pack(new Item(value));
        List<Pack> list = Stream.of(pack)
                .filter(PredicateX.old(Pack::getItem).map(Item::getName).nonNull())
                .collect(Collectors.toList());
        assertFalse(list.isEmpty());
    }
    ...
    public void checkNonNullNullableChaining() {
        Pack pack = new Pack(null);
        List<Pack> list = Stream.of(pack)
                .filter(PredicateX.oldSafe(Pack::getItem).map(Item::getName).nonNull())
                .collect(Collectors.toList());
        assertTrue(list.isEmpty());
    }
    ...
    public void checkEqual() {
        String value = "Coca-Cola";
        Pack pack = new Pack(new Item(value));
        Predicate<Pack> equalsCocaCola = PredicateX.old(Pack::getItem).map(Item::getName).equal(value);
    ...
    public void checkEqualNullable() {
        Holder<Box> holder = new Holder<>(new Box(null));
        Predicate<Holder<Box>> equal = PredicateX.oldSafe(Holder<Box>::get)
                .equal(new Box(null))
                .orTruth();
    ...
    public void checkEqualNullableComparable() {
        String value = "Coca-Cola";
        Pack pack = new Pack(null);
        Predicate<Pack> equalsCocaCola = PredicateX.oldSafe(Pack::getItem).map(Item::getName).equal(value).orLie();
    ...
    public void checkEqualChaining() {
        ...
        Pack pack = new Pack(new Item(value));
        List<Pack> list = Stream.of(pack)
                .filter(PredicateX.oldSafe(Pack::getItem).map(Item::getName).equal(value).orTruth())
                .collect(Collectors.toList());
        assertFalse(list.isEmpty());
    }
    ...
    public void checkEqualNullableChaining() {
        ...
        Pack pack = new Pack(null);
        List<Pack> list = Stream.of(pack)
                .filter(PredicateX.oldSafe(Pack::getItem).map(Item::getName).equal(value).orLie())
                .collect(Collectors.toList());
        assertTrue(list.isEmpty());
    }
    ...
    public void checkLessWithComparator() {
        ...
        Predicate<Box> lessPepsi = PredicateX.old(Box::getPack)
    ...
    public void checkLessNullableWithComparator() {
        ...
        Pack pack = new Pack(new Item("Coca-Cola"));
        Predicate<Box> lessPepsi = PredicateX.oldSafe(Box::getPack)
                .less(pack, Comparator.comparing(p -> p.getItem().getName()))
                .orLie();
        assertFalse(lessPepsi.test(box));
    }
    ...
    public void checkLessWithComparatorChaining() {
        ...
        List<Box> list = Stream.of(box)
                .filter(PredicateX.old(Box::getPack).less(pack, Comparator.comparing(p -> p.getItem().getName())))
                .collect(Collectors.toList());
        assertTrue(list.isEmpty());
    }
    ...
    public void checkLessNullableWithComparatorChaining() {
        ...
        Pack pack = new Pack(new Item("Coca-Cola"));
        List<Box> list = Stream.of(box)
                .filter(PredicateX.oldSafe(Box::getPack)
                        .less(pack, Comparator.comparing(p -> p.getItem().getName()))
                        .orLie())
                .collect(Collectors.toList());
        assertTrue(list.isEmpty());
    ...
    public void checkLessChaining() {
        ...
        Box box = new Box(new Pack(new Item(value)));
        List<Box> list = Stream.of(box)
                .filter(PredicateX.old(Box::getPack)
                        .map(Pack::getItem)
                        .map(Item::getName)
                        .less("Pepsi"))
                .collect(Collectors.toList());
    ...
    public void checkGreaterWithComparator() {
        ...
        Predicate<Box> greaterCocaCola = PredicateX.old(Box::getPack)
    ...
    public void checkGreaterNullableWithComparator() {
        Box box = new Box(null);
        Pack pack = new Pack(new Item("Schweppes"));
        Predicate<Box> greaterCocaCola = PredicateX.oldSafe(Box::getPack)
                .greater(pack, Comparator.comparing(p -> p.getItem().getName()))
                .orLie();
        assertFalse(greaterCocaCola.test(box));
    }
    ...
    public void checkGreaterWithComparatorChaining() {
        ...
        Pack pack = new Pack(new Item("Schweppes"));
        List<Box> list = Stream.of(box)
                .filter(PredicateX.old(Box::getPack).greater(pack, Comparator.comparing(p -> p.getItem().getName())))
                .collect(Collectors.toList());
        assertTrue(list.isEmpty());
    }
    ...
    public void checkLessOrEqual() {
        Holder<Box> holder = new Holder<>(new Box(null));
        Predicate<Holder<Box>> lessOrEqual = PredicateX.old(Holder<Box>::get)
    ...
    public void checkLessOrEqualComparable() {
        ...
        Predicate<Box> lessOrEqual = PredicateX.old(Box::getPack)
                .map(Pack::getItem)
                .map(Item::getName)
                .lessOrEqual("Mirinda");
    ...
    public void checkLessOrEqualNullable() {
        ...
        Predicate<Box> lessOrEqual = PredicateX.oldSafe(Box::getPack)
    ...
    public void checkGreaterOrEqual() {
        Holder<Box> holder = new Holder<>(new Box(null));
        Predicate<Holder<Box>> greaterCocaCola = PredicateX.old(Holder<Box>::get)
    ...
    public void checkMapNullable() {
        assertTrue(PredicateX.oldSafe(Pack::getItem)
                .map(Item::getPart)
                .isNull()
    ...
    public void checkMapToNullable() {
        assertTrue(PredicateX.old(Holder<Box>::get)
    ...
    public void checkMapToNullableWithComparable() {
        assertTrue(PredicateX.old(Box::getPack)
    ...
    public void checkOrElseBoolean() {
        assertTrue(PredicateX.oldSafe(Box::getPack)
    ...
    public void checkOrLieNullable() {
        assertFalse(PredicateX.oldSafe(Box::getPack)
                .check(Objects::isNull)
                .orLie()
                .test(new Box(null)));
    }
